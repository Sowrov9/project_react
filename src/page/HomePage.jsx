      ...
      <div className="row">
        <div className="col-xl-6 col-sm-6">
          <div className="card">
            <div className="card-body d-flex align-items-center justify-content-between">
              <div className="menu">
                <span className="font-w500 fs-16 d-block mb-2">Total Menus</span>
                <h2>459</h2>
              </div>	
        ...
        <div className="col-xl-6 col-sm-6">
          <div className="card">
            <div className="card-body d-flex align-items-center justify-content-between">
              <div className="menu">
                <span className="font-w500 fs-16 d-block mb-2">Total Revenue</span>
                <h2>$87,561</h2>
              </div>	
              <div className="d-inline-block position-relative donut-chart-sale">
                <span className="donut1" data-peity="{ &quot;fill&quot;: [&quot;rgb(98, 79, 209,1)&quot;, &quot;rgba(247, 245, 255)&quot;],   &quot;innerRadius&quot;: 35, &quot;radius&quot;: 10}">5/6</span>
                <small className="text-black">
        ...
        <div className="col-xl-6 col-sm-6">
          <div className="card">
            <div className="card-body d-flex align-items-center justify-content-between">
              <div className="menu">
                <span className="font-w500 fs-16 d-block mb-2">Total Oders</span>
                <h2>247</h2>
              </div>	
              <div className="d-inline-block position-relative donut-chart-sale">
                <span className="donut1" data-peity="{ &quot;fill&quot;: [&quot;rgb(98, 79, 209,1)&quot;, &quot;rgba(247, 245, 255)&quot;],   &quot;innerRadius&quot;: 35, &quot;radius&quot;: 10}">5/8</span>
        ...
        <div className="col-xl-6 col-sm-6">
          <div className="card">
            <div className="card-body d-flex align-items-center justify-content-between">
              <div className="menu">
                <span className="font-w500 fs-16 d-block mb-2">Total Customers</span>
                <h2>872</h2>
              </div>	
              <div className="d-inline-block position-relative donut-chart-sale">
                <span className="donut1" data-peity="{ &quot;fill&quot;: [&quot;rgb(98, 79, 209,1)&quot;, &quot;rgba(247, 245, 255)&quot;],   &quot;innerRadius&quot;: 35, &quot;radius&quot;: 10}">5/7</span>
                <small className="text-black">
        ...
        <div className="col-xl-12">
          <div className="card">
            ...
            <div className="card-body pb-0">
              <div className="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
                <span className="num">#1</span>
                <div className="me-auto pe-3">
                  <a href="ecom-product-grid.html"><h2 className="text-black fs-14 font-w600">Medium Spicy Spagethi Italiano</h2></a>
              ...
              <div className="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
                ...
                <div className="me-auto pe-3">
                  <a href="ecom-product-grid.html"><h2 className="text-black fs-14 font-w600">Watermelon juice with ice</h2></a>
                  <span className="text-black font-w600 d-inline-block me-3">$5.6 </span> <span className="fs-14">Order 89x</span>
                </div>
              ...
              <div className="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
                ...
                <div className="me-auto pe-3">
                  <a href="ecom-product-grid.html"><h2 className="text-black fs-14 font-w600">Chicken curry special with cucumber</h2></a>
                  <span className="text-black font-w600 d-inline-block me-3">$5.6 </span> <span className="fs-14">Order 89x</span>
                </div>
              ...
              <div className="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
                ...
                <div className="me-auto pe-3">
                  <a href="ecom-product-grid.html"><h2 className="text-black fs-14 font-w600">Italiano Pizza With Garlic</h2></a>
                  <span className="text-black font-w600 d-inline-block me-3">$5.6 </span> <span className="fs-14">Order 89x</span>
                </div>
              ...
              <div className="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
                ...
                <div className="me-auto pe-3">
                  <a href="ecom-product-grid.html"><h2 className="text-black fs-14 font-w600">Tuna Soup spinach with himalaya salt</h2></a>
                  <span className="text-black font-w600 d-inline-block me-3">$5.6 </span> <span className="fs-14">Order 89x</span>
                </div>
                <img src="images/menu/pic1.jpg" alt />
              </div>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="progress default-progress">
                <div className="progress-bar bg-gradient-1 progress-animated" style={{width: '45%', height: 11}} role="progressbar">
              ...
              <div className="d-flex align-items-end mt-2 pb-4 justify-content-between">
                ...
                <span className="fs-14"><span className="text-black pe-2" />452 times</span>
              </div>
              <div className="progress default-progress">
                <div className="progress-bar bg-gradient-1 progress-animated" style={{width: '30%', height: 11}} role="progressbar">
                  <span className="sr-only">30% Complete</span>
                </div>
              </div>
              <div className="d-flex align-items-end mt-2 pb-4 justify-content-between">
                <span className="fs-16 text-primary font-w600">#breakfast</span>
                <span className="fs-14"><span className="text-black pe-2" />97 times</span>
              </div>
              <div className="progress default-progress">
                <div className="progress-bar bg-gradient-1 progress-animated" style={{width: '45%', height: 11}} role="progressbar">
                  <span className="sr-only">45% Complete</span>
              ...
              <div className="d-flex align-items-end mt-2 pb-4 justify-content-between">
                ...
                <span className="fs-14"><span className="text-black pe-2" />61 times</span>
              </div>
              <div>
                <h4 className="fs-20 mb-3">Others tag</h4>
                <div>
                  <a href="javascript:void(0);" className=" btn btn-outline-primary btn-rounded me-2 mb-3 btn-sm">#japanessefood</a>
                  <a href="javascript:void(0);" className=" btn btn-outline-primary btn-rounded mb-3  btn-sm">#design</a>
                  <a href="javascript:void(0);" className=" btn btn-outline-primary btn-rounded me-2 mb-3 btn-sm">#projectmanagement</a>
                  <a href="javascript:void(0);" className=" btn btn-outline-primary btn-rounded btn-sm mb-3">16+</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="card customer-wrapper">
                <div className="card-header border-0">
                  ...
                  <div className="add-btn">
                    <a href="javascript:void(0);"><i className="fas fa-plus" /></a>
                  </div>
                </div>
                <div className="card-body height400 loadmore-content dz-scroll pb-0 pt-0" id="CustomerListContent">
                  <div className="d-flex align-items-center mb-4">
                    <div className="recent-customer me-3">
                      <img src="images/contacts/c1.jpg" width={50} alt />
                    </div>
                    <div>
                      <span className="c-name">Benny Chagur</span>
                  ...
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <div>
                      <span className="c-name">Chynita Bella</span>
                      <p className="font-w600 mb-0 text-primary">MEMBER</p>
                    </div>
                  </div>	
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <div>
                      <span className="c-name">David Heree</span>
                      <p className="font-w600 mb-0">Regular Customer</p>
                    </div>
                  </div>	
                  <div className="d-flex align-items-center mb-4">
                    <div className="recent-customer me-3">
                    ...
                    <div>
                      <span className="c-name">Evan D. Mas</span>
                      <p className="font-w600 mb-0 text-primary">MEMBER</p>
                    </div>
                  </div>	
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <div>
                      <span className="c-name">Supratman</span>
                      <p className="font-w600 mb-0">Regular Customer</p>
                    </div>
                  </div>	
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      <span className="c-name">John Kusnaidi</span>
                      <p className="font-w600 mb-0">Regular Customer</p>
                    </div>
                  </div>	
                </div>
                <div className="card-footer border-0 down-arrow pb-0">
                  <a href="javascript:void(0);" className="dz-load-more fas fa-chevron-down" id="CustomerList" rel="ajax/customer-list.html" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="card">
                ...
                <div className="card-body pb-0">
                  <img src="images/map1.png" className="w-100" alt />
                  ...
                  <div className="loadmore-content dz-scroll" id="DelieveryListContent">
                    <div className="d-sm-flex d-block border-bottom align-items-center mb-2">
                      <div className="delivery-customer me-auto mb-2">
                        <img src="images/contacts/c33.jpg" alt />	
                        <div>	
                          <span className="font-w600 text-black fs-16">John Kusnaidi <span className="text-primary">(4 Items)</span></span>
                      ...
                      <div className="d-flex align-items-center justify-content-end text-end location mb-2">
                        <div>
                          <span className="d-block f-s14 font-w400 text-black">Franklin Avenue St. London, ABC 12345</span>
                    ...
                    <div className="d-sm-flex d-block border-bottom align-items-center mb-2">
                      <div className="delivery-customer me-auto mb-2">
                        ...
                        <div>	
                          <span className="font-w600 text-black fs-16">Margaretha  <span className="text-primary">(2 Items)</span></span>
                          <span className="d-block fs-12 font-w600">Will be shipping on 11 : 24 AM</span>
                        </div>	
                      </div>
                      <div className="d-flex align-items-center justify-content-end text-end location mb-2">
                        <div>
                          <span className="d-block f-s14 font-w400 text-black">Groove Street Families, DEF 244125</span>
                          <span className="text-end f-s14 font-w400 text-black">United Kingdom</span>
                        </div>
                        <i className="fas fa-map-marker-alt" />
                      </div>
                    ...
                    <div className="d-sm-flex d-block border-bottom align-items-center mb-2">
                      <div className="delivery-customer me-auto mb-2">
                        ...
                        <div>	
                          <span className="font-w600 text-black fs-16">Richard Lee   <span className="text-primary">(4 Items)</span></span>
                          <span className="d-block fs-12 font-w600">Will be shipping on 11 : 24 AM</span>
                        </div>	
                      </div>
                      <div className="d-flex align-items-center justify-content-end text-end location mb-2">
                        <div>
                          <span className="d-block f-s14 font-w400 text-black">Bossman St. 21444 ABC</span>
                          <span className="text-end f-s14 font-w400 text-black">United Kingdom</span>
                        </div>
                        <i className="fas fa-map-marker-alt" />
                      </div>
                ...
                <div className="card-footer border-0 down-arrow pb-0">
                  <a href="javascript:void(0);" className="dz-load-more fas fa-chevron-down" id="DelieveryList" rel="ajax/delevery.html" />
                </div>
              </div>
            </div>
          </div>
